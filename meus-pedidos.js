...
<head>
  ...
  <link rel="icon" type="image/png" href="img/marca/lotus_logo.png" />
</head>
<body>
  <!-- NAV -->
  <nav>
    <a href="index.html#home" class="nav-logo">
      <img src="img/marca/lotus_logo.png" alt="Livraria Ātma Vidyā" />
    ...
    <div class="nav-centro">
      <ul class="nav-links" id="nav-links">
        ...
        <li><a href="samkhya.html">Sámkhya</a></li>
        <li><a href="satsanga.html">Satsánga</a></li>
  ...
  <footer>
    ...
    <img src="img/marca/lotus_logo.png" alt="Livraria Ātma Vidyā" class="footer-om" />
  </footer>
  ...
  <script src="ojas-chat.js"></script>
</body>
</html>
